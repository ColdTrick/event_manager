...
return array (
  ...
  'event_manager:settings:ical_direct:enable' => 'iCal mogelijkheden inschakelen',
  'event_manager:settings:ical_direct:enable:help' => 'Schakel de iCal mogelijkheden voor import en export in',
  'event_manager:ical_direct' => 'iCal',
  'event_manager:ical_direct:export' => 'Exporteer naar iCal',
  'event_manager:ical_direct:export:calendar_type' => 'Kalender',
  'event_manager:ical_direct:export:calendar_type:help' => 'Selecteer de kalender om te exporteren',
  'event_manager:ical_direct:calendar_type:all' => 'Alles',
  'event_manager:ical_direct:calendar_type:group' => 'Groep',
  'event_manager:ical_direct:calendar_type:owner' => 'Gebruiker',
  'event_manager:ical_direct:export:owner' => 'Gebruiker',
  'event_manager:ical_direct:export:owner:help' => 'Selecteer de gebruiker om de kalender van te exporteren',
  'event_manager:ical_direct:export:group' => 'Groep',
  'event_manager:ical_direct:export:group:help' => 'Selecteer de groep om de kalender van de exporteren',
  'event_manager:ical_direct:export:timespan' => 'Tijdsbereik van de export',
  'event_manager:ical_direct:export:start' => 'Startdatum',
  'event_manager:ical_direct:export:end' => 'Einddatum',
  'event_manager:ical_direct:export:region' => 'Regio',
  'event_manager:ical_direct:export:region:help' => 'Selecteer één of meerdere regio\'s om te filteren',
  'event_manager:ical_direct:export:type' => 'Type',
  'event_manager:ical_direct:export:type:help' => 'Selecteer één of meerdere evenement types om te filteren',
  'event_manager:ical_direct:export:submit' => 'Exporteer',
  'event_manager:ical_direct:export:errors:groupempty' => 'Geen groep opgegeven',
  'event_manager:ical_direct:export:errors:ownerempty' => 'Geen eigenaar opgegeven',
  'event_manager:ical_direct:export:errors:ownermismatch' => 'Je moet een beheerder zijn om de kalender van een andere gebruiker te kunnen exporteren',
  'event_manager:ical_direct:export:errors:errorinstantiatingcalendar' => 'Fout tijdens het maken van de kalender: %s',
  'event_manager:ical_direct:export:errors:erroraddingevent' => 'Fout tijdens het toevoegen van een evenement aan de kalender: %s',
  'event_manager:ical_direct:export:errors:errorcreatingcalendar' => 'Fout tijden het maken van de kalender: %s',
  'event_manager:ical_direct:import' => 'Importeer iCal',
  'event_manager:ical_direct:import:calendar_type' => 'Kalender',
  'event_manager:ical_direct:import:calendar_type:help' => 'Selecteer de kalender om in te importeren',
  'event_manager:ical_direct:import:owner' => 'Gebruiker',
  'event_manager:ical_direct:import:owner:help' => 'Selecteer de gebruiker van wie de kalender wordt gebruikt voor de import',
  'event_manager:ical_direct:import:group' => 'Groep',
  'event_manager:ical_direct:import:group:help' => 'Selecteer de groep om de kalender in te importern',
  'event_manager:ical_direct:import:file' => 'Import bestand',
  'event_manager:ical_direct:import:file:help' => 'ICS bestand om te importen',
  'event_manager:ical_direct:import:submit' => 'Importeer',
  'event_manager:ical_direct:import:success' => '%d evenementen zijn geïmporteerd',
  'event_manager:ical_direct:import:errors:groupempty' => 'Geen groep opgegeven',
  'event_manager:ical_direct:import:errors:invalidgroup' => 'Ongeldige groep opgegeven',
  'event_manager:ical_direct:import:errors:ownerempty' => 'Geen eigenaar opgegeven',
  'event_manager:ical_direct:import:errors:ownermismatch' => 'Je moet een beheerder zijn om te kunnen importeren in de kalender van een andere gebruiker',
  'event_manager:ical_direct:import:errors:grouppermission' => 'Je moet een beheerder zijn of mogen schrijven in de doel groep',
  'event_manager:ical_direct:import:errors:errorinstantiatingcalendar' => 'Fout tijdens het aanmaken van de kalender: %s',
  'event_manager:ical_direct:import:errors:errorpparsingcalendar' => 'Fout tijdens het inlezen van het kalender bestand: %s',
  'event_manager:ical_direct:import:errors:missingfile' => 'iCal bestand ontbreekt',
...
Indien u deze aanvraag niet heeft gedaan, kunt u deze mail negeren.',
  ...
  'event_manager:event:registration:notification:owner:text:event_attending' => '%s heeft zich ingeschreven als \'deelnemer\' voor jouw \'%s\' evenement.',
  ...
  'event_manager:event:registration:notification:owner:text:event_exhibiting' => '%s heeft zich ingeschreven als \'exposant\' voor jouw \'%s\' evenement.',
  ...
  'event_manager:event:registration:notification:owner:text:event_organizing' => '%s heeft zich ingeschreven als \'organisator\' voor jouw \'%s\' evenement.',
  ...
  'event_manager:event:registration:notification:owner:text:event_presenting' => '%s heeft zich ingeschreven als \'presentator\' voor jouw \'%s\' evenement.',
  ...
  'event_manager:event:registration:notification:owner:text:event_interested' => '%s heeft zich ingeschreven als \'geïnteresseerd\' voor jouw \'%s\' evenement.',
