...
Indien u deze aanvraag niet heeft gedaan, kunt u deze mail negeren.',
  ...
  'event_manager:event:registration:notification:owner:subject' => 'Nieuwe evenement registratie: %s',
  'event_manager:event:registration:notification:owner:subject:event_undo' => 'Evenement registratie ingetrokken: %s',
  'event_manager:event:registration:notification:user:subject' => 'Evenement registratie bevestiging: %s',
  'event_manager:event:registration:notification:user:subject:event_undo' => 'Evenement registratie ongedaan gemaakt: %s',
