...
return array(
	...
	'event_manager:edit:form:registration_completed' => 'Text to show when a user finishes the registration',
...
%s",
    ...
    'event_manager:ical_direct:calendar_type:all' => 'All',
    'event_manager:ical_direct:calendar_type:group' => 'Group',
    'event_manager:ical_direct:calendar_type:owner' => 'User',
    'event_manager:ical_direct:export:owner' => 'User',
    'event_manager:ical_direct:export:owner:help' => 'Select the user whose calendar will be exported',
    'event_manager:ical_direct:export:group' => 'Group',
    'event_manager:ical_direct:export:group:help' => 'Select the group which calendar will be exported',
    'event_manager:ical_direct:export:timespan' => 'Export timespan',
    'event_manager:ical_direct:export:start' => 'Start date',
    'event_manager:ical_direct:export:end' => 'End date',
    'event_manager:ical_direct:export:region' => 'Region',
    'event_manager:ical_direct:export:region:help' => 'Select one or more regions to filter for',
    ...
    'event_manager:ical_direct:import:calendar_type:help' => 'Select the calendar to import into',
    'event_manager:ical_direct:import:owner' => 'User',
    'event_manager:ical_direct:import:owner:help' => 'Select the user whose calendar will be used for the import',
    'event_manager:ical_direct:import:group' => 'Group',
    'event_manager:ical_direct:import:group:help' => 'Select the group which calendar will be user for the import',
    'event_manager:ical_direct:import:file' => 'Import file',
