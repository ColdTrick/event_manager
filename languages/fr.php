<?php 
	...
	$french = array(
		...
		'event_manager:edit:form:title' => 'Titre',
		...
		'event_manager:edit:form:access' => 'Accès',
		...
		'event_manager:registration:program:success' => "(Dés)inscription à l'emplacement sélectionné effectuée",
		'event_manager:registration:program:fail' => "Erreur : (Dés)inscription à l'emplacement sélectionné non effectuée",
...
une personne s'est désinscrite de l'évènement '%s' . Vous n'êtes plus sur la liste d'attente.",	
		...
		// relationships
		'event_manager:event:relationship:join' => 'Rejoindre l\'évènement',
		'event_manager:event:relationship:leave' => 'Quitter l\'évènement',
